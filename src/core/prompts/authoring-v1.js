export const AUTHORING_VOCABULARY_V1 = [
  ...
  "- Citation discipline: when you rely on external sources, keep identifiers machine-readable: use PMID: 12345678, DOI: 10.xxxx/xxxxx, arXiv: 2401.01234, and canonical https:// URLs.",
  "- When an answer cites sources, add a short ## Sources section when useful. Do not present your own inference as a source-backed claim unless the cited source supports it.",
  "- For synthesis or question-map answers based on selected nodes, preserve source identifiers from those nodes and distinguish direct sources from your synthesis/inference.",
